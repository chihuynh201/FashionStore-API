    ...
    public partial class AddCoreTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SkuAttributeValueId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SkuId = table.Column<int>(type: "int", nullable: false),
                    AttributeValueId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkuAttributeValues", x => x.SkuAttributeValueId);
                    table.ForeignKey(
                        name: "FK_SkuAttributeValues_AttributeValues_AttributeValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkuAttributeValues_AttributeValueId",
